...
@stats
def encode_image(img, alpha, defaultfreq, datafpath, verbosity, verbosity_level):
    """Encode an image"""
...
def encode(alpha, defaultfreq, img_fpath, datafpath, verbosity, verbosity_level):
    ...
    return encode_image(img, alpha, defaultfreq, datafpath, verbosity, verbosity_level)
...
def main():
    ...
    encode(alpha, defaultfreq, img_fpath, datafpath, verbosity, verbosity_level)
